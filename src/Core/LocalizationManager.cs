...
namespace SystemCoreMonitor.Core
{
    public static class LocalizationManager
    {
        ...
        private static readonly Dictionary<string, string> StringsEs = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "CardRunawayTitle", "Procesos desbocados detectados: {0}" },
            { "CardRunawaySubtitle", "Escaneos de disco completo o CPU alta sostenida. Revisa antes de terminar: nada se cierra solo." },
            { "RunawayKindScan", "Escaneo de disco" },
            { "RunawayKindSustained", "CPU sostenida" },
            { "RunawayReasonScan", "Recorre el disco completo ({0})" },
            { "RunawayReasonSustained", "Sobre {0:F0}% de CPU durante {1}" },
            { "ButtonRunawayEnd", "Terminar" },
            { "ConfirmOrphanKillTitle", "Cerrar procesos huérfanos" },
            { "ConfirmOrphanKill", "¿Cerrar {0} proceso(s) huérfano(s) y sus subprocesos? RAM total: {1}\n\n{2}\n\nUn padre muerto también es normal en procesos lanzados desde una terminal ya cerrada. Revisa la lista antes de confirmar." },
            { "ConfirmOrphanKillMore", "…y {0} más" },
            { "ConfirmLeftoverTitle", "Limpiar restos de agentes IA" },
            { "ConfirmLeftoverClean", "¿Eliminar {0} elemento(s) ({1})?\n\n{2}" },
            { "ConfirmRunawayTitle", "Terminar proceso desbocado" },
            { "ConfirmRunawayKill", "¿Terminar {0} (PID {1}) y sus subprocesos?\n\nMotivo: {2}\n\nComando: {3}" },
            { "ToastRunawayKilled", "✓ Proceso {0} (PID {1}) terminado" },
            { "ToastRunawayKillFailed", "⚠️ No se pudo terminar {0} (PID {1}): {2}" },
        ...
        private static readonly Dictionary<string, string> StringsEn = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "CardRunawayTitle", "Runaway processes detected: {0}" },
            { "CardRunawaySubtitle", "Disk-wide scans or sustained high CPU. Review before ending: nothing is closed automatically." },
            { "RunawayKindScan", "Disk scan" },
            { "RunawayKindSustained", "Sustained CPU" },
            { "RunawayReasonScan", "Walks the whole disk ({0})" },
            { "RunawayReasonSustained", "Above {0:F0}% CPU for {1}" },
            { "ButtonRunawayEnd", "End" },
            { "ConfirmOrphanKillTitle", "Close orphan processes" },
            { "ConfirmOrphanKill", "Close {0} orphan process(es) and their children? Total RAM: {1}\n\n{2}\n\nA dead parent is also normal for processes launched from a terminal that has since closed. Review the list before confirming." },
            { "ConfirmOrphanKillMore", "…and {0} more" },
            { "ConfirmLeftoverTitle", "Clean AI agent leftovers" },
            { "ConfirmLeftoverClean", "Delete {0} item(s) ({1})?\n\n{2}" },
            { "ConfirmRunawayTitle", "End runaway process" },
            { "ConfirmRunawayKill", "End {0} (PID {1}) and its child processes?\n\nReason: {2}\n\nCommand: {3}" },
            { "ToastRunawayKilled", "✓ Process {0} (PID {1}) ended" },
            { "ToastRunawayKillFailed", "⚠️ Could not end {0} (PID {1}): {2}" },
