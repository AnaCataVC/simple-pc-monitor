...
(function () {
  ...
  const translations = {
    es: {
      ...
      nav_faq: "FAQ",
      btn_download_nav: "Descargar v3.0.0",

      hero_pill: "Windows 10 / 11 Nativo • .NET 9 C# 13",
      hero_badge: "Versión 3.0.0 • 617 KB Standalone • .NET 9",
    ...
    en: {
      ...
      nav_faq: "FAQ",
      btn_download_nav: "Download v3.0.0",

      hero_badge: "Version 3.0.0 • 617 KB Standalone • .NET 9",
